...
const ZONE_MAPPING = {
  ...
  'Mangalore Hillside': 'Zone 2A', // Alias without hyphen
  ...
  // ZONE 3A - Ravishanakar Rao (4 clubs, 132 members total)
  'Mangalore Down Town': 'Zone 3A',
  'Mangalore Downtown': 'Zone 3A', // Alias
  'Mangalore South': 'Zone 3A',
  'Mangalore City': 'Zone 3A',
  'Deralakatte': 'Zone 3A',
  
  // ZONE 3B - Ravishanakar Rao (4 clubs, 166 members total)
  'Mangalore Seaside': 'Zone 3B',
  'Mangalore Sea Side': 'Zone 3B', // Alias
  'Mangalore Metro': 'Zone 3B',
  'Mangalore Midtown': 'Zone 3B',
  'Mangalore Mid-Town': 'Zone 3B', // Alias
  'Mangalore': 'Zone 3B',
  
  // ZONE 4A - (3 clubs, 71 members total)
  'Modankap': 'Zone 4A',
  'Farangipete': 'Zone 4A',
  'B C Road City': 'Zone 4A',
  'BC Road City': 'Zone 4A', // Alias
  ...
  // ZONE 4C - (4 clubs, 236 members total)
  'Moodabidri': 'Zone 4C',
  ...
  // ZONE 5A - (4 clubs, 179 members total)
  'Puttur Yuva': 'Zone 5A',
  'Puttur-East': 'Zone 5A',
  'Puttur East': 'Zone 5A', // Alias
  'Puttur Swarna': 'Zone 5A',
  'Puttur Elite': 'Zone 5A',
  
  // ZONE 5B - Balakrishna Pai (4 clubs, 195 members total)
  'Puttur': 'Zone 5B',
  ...
  'Periyapatna Midtown': 'Zone 6C', // Alias
  'Periyapatna Icons': 'Zone 6C',
  'Hunsur, Hunsur': 'Zone 6C',
  'Hunsur': 'Zone 6C', // Alias
  
  // ZONE 7A - Harish B (6 clubs, 278 members total)
  'Panchsheel Mysore': 'Zone 7A',
  'Panchsheel': 'Zone 7A', // Alias
  ...
  'Kollegal Midtown': 'Zone 9B' // Alias
};
...
const CLUB_MEMBERS = {
  ...
  'Mangalore Sea Side': 23, // Alias
  'Mangalore Metro': 42,
  'Mangalore Midtown': 23,
  'Mangalore Mid-Town': 23, // Alias
  'Mangalore': 78,
  ...
  'E Club Mysure Center': 31, // Alias
  'Mysore Mid-Town': 72,
  'Mysore Midtown': 72, // Alias
  'Central Mysore': 55,
  ...
  'Vijaynagar Mysore': 21, // Alias
  'Mysuru Diamond': 23,
  'Mysore Diamonds': 23, // Alias
  'Mysore North': 78,
  'Mysore Ambari': 19,
