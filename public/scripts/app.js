    ...
    modal.innerHTML = `
        ...
        ">
            ...
            <div style="background: linear-gradient(135deg, #D4AF37 0%, #C19A2E 100%); padding: 18px 15px; border-radius: 12px; margin: 20px 0; box-shadow: 0 4px 12px rgba(212, 175, 55, 0.3);">
                <div style="font-size: 15px; font-weight: 700; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 0.5px; color: #FF1493;">
                ...
                <div style="font-size: 14px; background: rgba(255, 255, 255, 0.15); padding: 12px; border-radius: 8px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                        <strong style="color: #FFD700;">Rotarian:</strong>
                        <div style="text-align: right;">
                            <span style="text-decoration: line-through; opacity: 0.8; color: #FFE8B3; font-size: 13px;">₹5,000</span><br>
                            <strong style="color: #FFF; font-size: 17px;">₹4,500</strong>
                        </div>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <strong style="color: #FFD700;">Rotarian with Spouse:</strong>
                        <div style="text-align: right;">
                            <span style="text-decoration: line-through; opacity: 0.8; color: #FFE8B3; font-size: 13px;">₹8,000</span><br>
                            <strong style="color: #FFF; font-size: 17px;">₹7,500</strong>
                        </div>
                    </div>
                </div>
            </div>
